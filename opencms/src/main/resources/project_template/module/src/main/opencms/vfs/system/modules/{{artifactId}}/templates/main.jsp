...
<%-- TITLE --%>
<c:set var="title" value="${cms.title}"/>
...
<input type="hidden" name="contextPath" id="contextPath" value="${pageContext.request.contextPath}${pageContext.request.servletPath}"/>
